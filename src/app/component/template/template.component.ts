...
export class TemplateComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    onEdit(row:any){
      ...
      dialogGonfig.disableClose = false;
      dialogGonfig.width = "350px";
      dialogGonfig.height = "100%";
      dialogGonfig.panelClass ="Right-dialog";
      dialogGonfig.position = {top:"0",right:"0"};
    ...
    Preview(row:any){
      ...
      dialogGonfig.disableClose = false;
      dialogGonfig.width = "400px";
      dialogGonfig.height = "100%";
      dialogGonfig.panelClass ="Right-dialog";
      dialogGonfig.position = {top:"0",right:"0"};

      this.dialog.open(PreviewComponent,dialogGonfig).afterClosed().subscribe(result => {
